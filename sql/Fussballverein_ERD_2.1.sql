...
CREATE TABLE person ( -- df: mult=100.0
...
CREATE TABLE spieler ( -- df: mult=100.0
 persnr INT NOT NULL PRIMARY KEY, -- df: nogen
...
CREATE TABLE standort ( -- df: mult=100.0
...
CREATE TABLE trainer ( -- df: mult=100.0
 persnr INT NOT NULL PRIMARY KEY, -- df: nogen
 gehalt DECIMAL(255) NOT NULL, -- df: pattern='[0-9]{4}'
 von DATE NOT NULL, -- df: date
 bis DATE NOT NULL, -- df: date
...
CREATE TABLE angestellter ( -- df: mult=100.0
 persnr INT NOT NULL PRIMARY KEY, -- df: nogen
 gehalt DECIMAL(255) NOT NULL, -- df: pattern='[0-9]{4}'
...
CREATE TABLE mannschaft ( -- df: mult=100.0
...
CREATE TABLE mitglied ( -- df: mult=100.0
 persnr INT NOT NULL PRIMARY KEY, -- df: nogen
...
CREATE TABLE spiel ( -- df: mult=100.0
...
CREATE TABLE spielt ( -- df: mult=100.0
...
CREATE TABLE assistent ( -- df: mult=100.0
...
CREATE TABLE beteiligt ( -- df: mult=100.0
 persnr INT NOT NULL, -- df: nogen
 datum TIMESTAMP(255) NOT NULL, -- df: timestamp
 mannschaft VARCHAR(255) NOT NULL, -- df: text=orte length=1
...
CREATE TABLE chef_trainer ( -- df: mult=100.0
 bezeichnung VARCHAR(255) NOT NULL, -- df: text=orte length=1
 persnr INT NOT NULL, -- df: nogen
...
CREATE TABLE fanclub ( -- df: mult=100.0
 name VARCHAR(255) NOT NULL, -- df: count
...
CREATE TABLE kapitaen ( -- df: mult=100.0
 persnr INT NOT NULL, -- df: nogen
 bezeichnung VARCHAR(255) NOT NULL, -- df: text=orte length=1
...
CREATE TABLE betreut ( -- df: mult=100.0
 name VARCHAR(255) NOT NULL, -- df: count
 sid INT NOT NULL, -- df: nogen
 persnr INT NOT NULL, -- df: nogen
