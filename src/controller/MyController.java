...
public class MyController implements Initializable {
	 ...
	 * by using the given params. In case they're working, the main select statement will be executed and displayed in the
	...
	public void handleButtonAction(ActionEvent event) {
		...
		try {
			...
			// the tabs are accessable, in case of a successful connection
			...
			// error handeling with error messages
	...
	/**
	 * updateClicked
	 * will be executed, if the "update" button for the row update is pressed. It takes the given params and puts
	...
	/**
	 * updateTableClicked
	 * will be executed, when the upper "update" button for the tableView is pressed. Cleares the whole tableView
